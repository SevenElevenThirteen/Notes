...
\begin{document}
    ...
    \section{重积分}
        ...
        常用换元：
        \begin{longtable}[h]{c | c | w{c}{5cm}}
            极坐标 & $\begin{cases}
                x = \rho \cos\theta \\
                y = \rho \sin\theta
            \end{cases}$ & $\dif s = \rho \sdif\rho \sdif\theta$ \\
            \addlinespace
            球 & $z = \sqrt{a^2 - x^2 - y^2}$ & $\dif s = \frac{a}{\sqrt{a^2 - x^2 - y^2}} \sdif x \sdif y$ \\
            \midrule
            球面坐标 & $\begin{cases}
                x = \rho \sin\varphi \cos\theta \\
                y = \rho \sin\varphi \sin\theta \\
                z = \rho \cos\theta
            \end{cases}$ & $\dif V = \rho^2 \sin\varphi \sdif\rho \sdif\theta \sdif\varphi$ \\
            \addlinespace
            柱面坐标 & $\begin{aligned}
                x = \rho \cos\theta \\
                y = \rho \sin\theta \\
                z = z
            \end{aligned}$ & $\dif V = \rho \sdif\rho \sdif\theta \sdif z$
        \end{longtable}
        ...
        $$\begin{aligned}
            F(y) &= \int_{l(y)}^{r(y)} f(x, y)\sdif x \quad \implies \quad G(y, l, r) = F(y) \\
            \implies& \frac{\partial G}{\partial y} = G_y + G_l \cdot \frac{\dif l}{\dif y} + G_r \cdot \frac{\dif r}{\dif y}
            = \boxed{\left[\int_{l(y)}^{r(y)} \frac{\partial f}{\partial y} \dif x\right] - f\left(l(y), y\right) \cdot \frac{\dif l}{\dif y} + f\left(r(y), y\right) \cdot \frac{\dif r}{\dif y}} 
        \end{aligned}$$
